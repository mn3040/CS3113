...
public:
    // ————— STATIC ATTRIBUTES ————— //
    static constexpr int ENEMY_COUNT = 24;
...
private:
    ...
    float m_glitch_intensity;
    float m_glitch_duration;
    float m_glitch_timer;
    bool m_is_glitching;
