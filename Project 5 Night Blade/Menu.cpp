...
void Menu::render(ShaderProgram* program) {
    ...
    Utility::draw_text(program, font_texture_id, "Night Blade", 0.75f, 0.02f, glm::vec3(-3.75f, 0.0f, 0.0f));
    Utility::draw_text(program, font_texture_id, "Press Enter to Play", 0.4f, 0.02f, glm::vec3(-3.5f, -1.0f, 0.0f));
    Utility::draw_text(program, font_texture_id, "Press I for Help", 0.4f, 0.02f, glm::vec3(-3.2f, -1.75f, 0.0f));
